...
export const metadata = {
    ...
    description: "A fae-forged puzzle collection blending trivia, crossword, and wordoku. Now on Android.",
};
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-12 text-moss-light">
            ...
            <section className="space-y-3">
                ...
                <p className="text-sm text-moss-faint italic">Now on Android</p>
                <p className="text-moss-light/80 text-lg">
                    Three puzzle trials forged into a single grimoire: trivia, crossword, and wordoku.
                    One enchanted question engine, three ways to wield it. Knowledge becomes your weapon.
                </p>
            </section>
            ...
            <section className="space-y-4">
                ...
                <p className="text-moss-light/60 text-sm italic">
                    Available now on Google Play. iOS pending Apple approval.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex items-center justify-center gap-3 backdrop-blur-md bg-white/3 border border-white/10 rounded-2xl px-6 py-4 ring-2 ring-[#FDE68A]/20 text-moss-light font-semibold opacity-40 pointer-events-none select-none">
                    ...
                    <a
                        href="https://play.google.com/store/apps/details?id=com.MorrowMossStudios.TriviaForge&hl=en_US"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-3 backdrop-blur-md bg-white/3 border border-white/10 rounded-2xl px-6 py-4 ring-2 ring-[#FDE68A]/20 text-moss-light font-semibold hover:bg-white/5 hover:ring-[#FDE68A]/40 transition"
                    >
