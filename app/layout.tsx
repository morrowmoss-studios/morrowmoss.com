        ...
        >
            ...
            <div className="absolute inset-0 z-10 pointer-events-none">
                {[...Array(35)].map((_, i) => {
                    ...
                    const size = `${2 + Math.random() * 2}px`; // slightly bigger
            ...
            <div className="relative z-20 flex flex-col min-h-screen">
                ...
                <header className="flex flex-col sm:flex-row items-center justify-between p-6 space-y-4 sm:space-y-0 border-b border-moss-faint">
                    ...
                    <nav className="flex flex-wrap justify-center space-x-6 text-moss-light">
                        <Link href="/" className="hover:text-[#f7eab5] hover:drop-shadow-[0_0_5px_#f7eab5] transition duration-300">Home</Link>
                        <Link href="/creations" className="hover:text-[#f7eab5] hover:drop-shadow-[0_0_5px_#f7eab5] transition duration-300">Creations</Link>
                        <Link href="/blog" className="hover:text-[#f7eab5] hover:drop-shadow-[0_0_5px_#f7eab5] transition duration-300">Blog</Link>
                        <Link href="/about" className="hover:text-[#f7eab5] hover:drop-shadow-[0_0_5px_#f7eab5] transition duration-300">About</Link>
                        <Link href="/contact" className="hover:text-[#f7eab5] hover:drop-shadow-[0_0_5px_#f7eab5] transition duration-300">Contact</Link>
                    </nav>
                </header>
                ...
                <footer className="text-center text-sm text-moss-faint py-6 border-t border-moss-faint">
                    <div className="flex justify-center space-x-6 mb-4">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/morrowmoss.studios/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300">
                        ...
                        {/* Itch.io */}
                        <a href="https://morrowmossstudios.itch.io" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-300">
